...
export function ContactCard({
	...
	return (
		<div
			...
			{...props}
		>
			<PlusIcon className="absolute -top-3 -left-3 size-6 text-purple" />
			<PlusIcon className="absolute -top-3 -right-3 size-6 text-purple" />
			<PlusIcon className="absolute -bottom-3 -left-3 size-6 text-purple" />
			<PlusIcon className="absolute -right-3 -bottom-3 size-6 text-purple" />
